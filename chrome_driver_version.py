...
def download_latest_version(version_number: str, driver_directory: str):
    """
    ...
    download_url = f"https://chromedriver.storage.googleapis.com/{version_number}/chromedriver_{obtain_os()}.zip"
    print(download_url)
...
def check_driver(driver_directory: str):
    """
